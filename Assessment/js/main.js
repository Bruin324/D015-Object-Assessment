...
/*************************************************************************************
------------ ANSWER -------------------
No, x is a global variable. y is a local variable. console.log(x) will print "I'm a local variable" regardless of where it is called. Console.log(y) will print "I'm a global variable" only if it is called in scopeThis()
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) would print 'undefined'. There is no console.log(y). If you meant "What would console.log(foo()) print?" then that will print "function hoisting"
**************************************************************************************/
